 ...
 * ch.admin.bit.jeap.messagetype.jeap:create-audit-record-command - [ch.admin.bit.jeap.messagetype.jeap:create-audit-record-command](https://github.com/jeap-admin-ch/jeap-message-type-registry/tree/main)
