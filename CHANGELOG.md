...
- update jeap-starter from 25.8.0 to 25.9.0
...
- update jeap-starter from 25.3.0 to 25.4.0
...
- update jeap-messaging-outbox from 18.4.0 to 18.5.0

## [11.3.0] - 2026-09-15

### Changed
- Update parent from 9.6.0 to 9.6.1
- update jeap-starter from 25.2.0 to 25.3.0
...
- update jeap-messaging-outbox from 18.2.0 to 18.3.0
...
- update jeap-messaging-outbox from 17.30.0 to 17.31.0

## [10.27.0] - 2026-09-09

### Changed
- Update parent from 9.4.0 to 9.4.1
- update jeap-starter from 24.31.0 to 24.32.0
...
- update jeap-starter from 24.28.0 to 24.29.0
...
- update jeap-messaging-outbox from 17.26.0 to 17.27.0
...
- update jeap-messaging-outbox from 17.24.0 to 17.25.0
...
- update jeap-starter from 24.23.1 to 24.24.0
...
## [10.19.2] - 2026-08-28
### Changed
- update jeap-messaging-outbox from 17.21.1 to 17.21.2
...
- update jeap-starter from 24.22.0 to 24.23.0
...
- update jeap-messaging-outbox from 17.19.1 to 17.20.0
...
- update jeap-messaging-outbox from 17.17.0 to 17.18.0
...
- update jeap-messaging-outbox from 17.15.0 to 17.16.0
...
- update jeap-messaging-outbox from 17.12.0 to 17.13.0
...
- update jeap-messaging-outbox from 17.11.0 to 17.12.0
...
- update jeap-messaging-outbox from 17.9.0 to 17.10.0
...
- update jeap-messaging-outbox from 17.7.0 to 17.8.0
...
- update jeap-messaging-outbox from 17.4.0 to 17.4.1
...
- update jeap-messaging-outbox from 16.2.0 to 16.3.0
...
- update jeap-messaging-outbox from 15.20.0 to 16.0.0
...
- update jeap-messaging-outbox from 15.17.0 to 15.18.0
...
- update jeap-messaging-outbox from 15.16.0 to 15.17.0
...
- update jeap-messaging-outbox from 15.15.0 to 15.16.0
...
- update jeap-messaging-outbox from 15.13.1 to 15.13.2
...
- update jeap-messaging-outbox from 15.13.0 to 15.13.1
